                ...
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <form class="auth-login-form mt-2" action="javascript:void(0)" id="form-login" method="POST">
                                @csrf
                                ...
                                <button type="button" id="btn-submit-login" class="btn btn-primary w-100" tabindex="4">Sign in</button>
                            </form>
                            <p class="text-center mt-2"><span>New on our platform?</span><a href="{{ url('registrasi') }}"><span>&nbsp;Create an account</span></a></p>
    ...
    $('#btn-submit-login').on('click', function(e){
        ...
        $.ajax({
            ...
            success: function(data){
                setCookie('token', data.accessToken, 0.5)
